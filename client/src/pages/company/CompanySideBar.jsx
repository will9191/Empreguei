...
const SideBar = () => {
  ...
  const navigation = [
    ...
    { link: '/Company/edit-photo', text: 'Editar logo' },
    { link: '/Company/description', text: 'Descrição' },
    { link: '/Company/Contact', text: 'Contato' },
    { link: '/Company/photos', text: 'Fotos' },
    { link: '/Company/plans', text: 'Planos' },
    { link: '/Company/Account', text: 'Minha Conta' },
  ];
